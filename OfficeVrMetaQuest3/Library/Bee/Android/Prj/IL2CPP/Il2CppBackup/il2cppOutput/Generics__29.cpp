...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR RuntimeObject* Dictionary_2_System_Collections_IDictionary_get_Item_mE773BE077E2E6382FB3C13A58EB0B840ACF7FBE7_gshared (Dictionary_2_t2B61363D34F3B997BF09809491195DFA8918B538* __this, RuntimeObject* ___0_key, const RuntimeMethod* method) 
{
	int32_t V_0 = 0;
	{
		...
		bool L_1;
		L_1 = Dictionary_2_IsCompatibleKey_mE19562D09ED2F75472255DEF6ADADADB310383D3(L_0, il2cpp_rgctx_method(method->klass->rgctx_data, 57));
		if (!L_1)
		{
			goto IL_0030;
		}
	}
	{
		...
		int32_t L_3;
		L_3 = Dictionary_2_FindEntry_m1495A09367E22CA28A287834F68B236A944DEC95(__this, ((*(SourceOwner_t170D5DAFCF83341BC92035E2A62A97F087B11779*)UnBox(L_2, il2cpp_rgctx_data(method->klass->rgctx_data, 14)))), il2cpp_rgctx_method(method->klass->rgctx_data, 30));
		V_0 = L_3;
		int32_t L_4 = V_0;
		if ((((int32_t)L_4) < ((int32_t)0)))
		{
...
IL_0009:
	...
	try
	{
		...
		try
		{
			...
			Dictionary_2_set_Item_m4E3E51E78403A2E6DE601B34EA5F92E51E37C559(__this, L_3, ((RuntimeObject*)Castclass((RuntimeObject*)L_4, il2cpp_rgctx_data(method->klass->rgctx_data, 15))), il2cpp_rgctx_method(method->klass->rgctx_data, 60));
			goto IL_003a_1;
		}
		catch(Il2CppExceptionWrapper& e)
		{
