...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR RuntimeObject* Dictionary_2_System_Collections_IDictionary_get_Item_m61AA733E667C86776586CD4B63489FA17B9940DA_gshared (Dictionary_2_tECE4A3D696AB8B2AF0D47C4D29C5BE0D27759BEF* __this, RuntimeObject* ___0_key, const RuntimeMethod* method) 
{
	int32_t V_0 = 0;
	{
		RuntimeObject* L_0 = ___0_key;
		bool L_1;
		L_1 = Dictionary_2_IsCompatibleKey_mC483C82343BA2D53C5139187D95BE8A9F685F290(L_0, il2cpp_rgctx_method(method->klass->rgctx_data, 57));
		if (!L_1)
		{
			goto IL_0030;
		}
...
IL_0009:
	{
		RuntimeObject* L_1 = ___1_value;
		ThrowHelper_IfNullAndNullsAreIllegalThenThrow_TisTextureHandle_t87D7D063E5E22E38632961AB2B6F89978942BE09_m20DEB1F9955B6851058DD299DF91DEA7189B616C(L_1, (int32_t)((int32_t)15), il2cpp_rgctx_method(method->klass->rgctx_data, 59));
	}
	try
	{
		{
		...
		try
		{
			Hash128_t93367F504B687578F893CDBCD13FB95AC8A87A40 L_3 = V_0;
			RuntimeObject* L_4 = ___1_value;
			Dictionary_2_set_Item_mB16CC417BFD9B9AE8376522B3F36A5A6F84287FF(__this, L_3, ((*(TextureHandle_t87D7D063E5E22E38632961AB2B6F89978942BE09*)UnBox(L_4, il2cpp_rgctx_data(method->klass->rgctx_data, 15)))), il2cpp_rgctx_method(method->klass->rgctx_data, 60));
			goto IL_003a_1;
		}
		catch(Il2CppExceptionWrapper& e)
		{
